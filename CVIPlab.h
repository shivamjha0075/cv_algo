...
extern Image *croplab();
extern Image* zoom_lab();
extern void* area_lab();
extern void* euler_lab();
extern Image* sobel_edge_lab();
extern Image* roberts_edge_lab();
extern Image* dilation_lab();
extern Image* erosion_lab();
extern float rmserror();
extern float peak_snr();
extern Image* lowpass();
extern Image* highpass();
extern Image* spatial_lowpass();
extern Image* spatial_highpass();
extern Image* meanfilter();
#endif
